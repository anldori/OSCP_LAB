...
Search for "8080", we know that this page require "User-Agent ^Mozilla/4.0" to access it. Open http://172.10.1.48:8080 with BurpSuite, replace the User-Agent to Mozilla/4.0, we found the Index page of phptax:
